...
def generate_capsules(
    ...
    """
    Генерация капсул V6 (импорт из capsule_engine_v6) - НОВАЯ ЛОГИКА ПО ТКАНЯМ!
    """
    try:
        from capsule_engine_v6 import generate_capsules as generate_capsules_v6
        return generate_capsules_v6(
        ...
        print(f"⚠️ V6 не найден ({e}), используем старую V4 логику")
